...
public class Simulador {
    ...
    public boolean cargarEstado() {
        // Esta función ahora simplemente llama a la nueva con el archivo por defecto
    ...
    public boolean cargarEstado(String rutaArchivo) {
        ...
        // Usamos rutaArchivo en lugar de ESTADO_FILE
